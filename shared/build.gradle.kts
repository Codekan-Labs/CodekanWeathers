...
kotlin {
    ...
    iosTargets.forEach {
        it.binaries.framework {
            baseName = "shared"
            isStatic = true
            binaryOption("bundleId", "com.codekan.weathers.shared") // Bundle ID for the iOS framework
        }
    }
    ...
    sourceSets {
        ...
        iosMain.dependencies {
            ...
            implementation(libs.ktor.ios) // Ktor client iOS dependency for shared module
...
android {
    namespace = "com.codekan.weathers.shared"
    compileSdk = 35
    defaultConfig {
        minSdk = 24
    }
